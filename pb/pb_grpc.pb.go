...
func (c *auctionServiceClient) ReplicateBid(ctx context.Context, in *ReplicateBidRequest, opts ...grpc.CallOption) (*ReplicateBidResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedAuctionServiceServer) ReplicateBid(context.Context, *ReplicateBidRequest) (*ReplicateBidResponse, error) {
...
func _AuctionService_ReplicateBid_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuctionServiceServer).ReplicateBid(ctx, req.(*ReplicateBidRequest))
	}
	return interceptor(ctx, in, info, handler)
}
